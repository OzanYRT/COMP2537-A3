...
const updatePaginationDiv = (currentPage, numPages) => {
  ...
  if (currentPage > 1) {
    $('#pagination').append(`
      <li class="page-item">
        <button class="page-link firstButton" value="1">First</button>
      </li>
      <li class="page-item">
  ...
  if (currentPage < numPages) {
    $('#pagination').append(`
      ...
      <li class="page-item">
        <button class="page-link lastButton" value="${numPages}">Last</button>
      </li>
    `);
  }
};
...
// add event listener to type checkboxes
  ...
  $('body').on('click', ".numberedButtons, .previousButton, .nextButton, .firstButton, .lastButton", async function (e) {
